;;; $Id: fracc.el,v 1.33 2007/01/30 17:34:13 queinnec Exp queinnec $
...
;;; $Date: 2007/01/30 17:34:13 $|$Revision: 1.33 $|
;;; ~/misc/fracc.el.Z|
...
Possible encodings are:
	...
	fracc-ISO-8859-15-encoding
	fracc-ISO-UTF-8-encoding
	fracc-tex-encoding
...
(defvar fracc-ISO-8859-encoding
  '(nil ; respect case of letters.
    ...
    (?u                ; means only u
     ("c," "\347")
     ("C," "\307")
     ;; nothing for OE (as noted by besancon@excalibur.ens.fr
     ;; (BESANCON Thierry)) nothing for punctuations.
     ("oe"  "\04275")
    )
    (?<
     ("<" . "\253 ") )
...
(defvar fracc-ISO-8859-15-encoding
  '(nil ; respect case of letters.
    (?'
     ("E" . "\311")
     ("e" . "\351")
  ...
  "This is the French encoding towards ISO 8859-15 accented letters." )

(defvar fracc-UTF-8-encoding
  '(nil ; respect case of letters.
    (?'
     ("E" . 04311)
     ("e" . 04351)
    ...
    (?U                ; means only U
     ("c," . 04347)
     ("C," . 04307)
     ("oe" . 04523)    ; 0153 latin small ligature oe
     ("OE" . 04522)    ; 0152 latin capital ligature oe
    )
    (?<
     ("<" . 04253) )
    (?>
  ...
  "This is the French encoding towards ISO UTF-8 accented letters." )
...
(put 'tex-mode		'fracc-encoding fracc-ISO-8859-15-encoding)
(put 'plain-tex-mode	'fracc-encoding fracc-ISO-8859-15-encoding)
(put 'latex-mode	'fracc-encoding fracc-ISO-8859-15-encoding)
(put 'slitex-mode	'fracc-encoding fracc-ISO-8859-15-encoding)
...
(setq fracc-default-encoding fracc-ISO-8859-15-encoding)
